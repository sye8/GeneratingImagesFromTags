...
if __name__ == '__main__':
    ...
    #parser.add_argument('--ckpt_path', type = str, default = 'ckpts/retrain/dVAE_lastest.ckpt')
    ...
    train_group.add_argument('--beta_anneal_rate', type = float, default = 1e-4, help = 'beta annealing rate')
...
#        kl_div_loss_weight = kl_div_weight
    ...
    for epoch in range(START_EPOCH, NUM_EPOCHS):
        ...
        if (epoch + 1) % SAVE_STEP == 0:
            ckpt_name = "dVAE_" + str(epoch+1) + ".ckpt"
        else:
            ckpt_name = "dVAE_lastest.ckpt"
